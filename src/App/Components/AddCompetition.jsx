  ...
  return (
    ...
    <form onSubmit={handleSubmit}>
      ...
      <div className="form-group">
        ...
        <input type="tel" className="form-control" id="date" placeholder="Enter date"
      ...
      <div className="form-group">
        ...
        <input type="tel" className="form-control" id="participants" placeholder="Enter number of participats"
      ...
      <div className="form-group">
        ...
        <input type="tel" className="form-control" id="description" placeholder="Enter  description"
